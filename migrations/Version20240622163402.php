 ...
 */
final class Version20240622163402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_tally (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, player_id INT NOT NULL, score INT NOT NULL, leg_id INT NOT NULL, set_id INT DEFAULT NULL, legs_won INT NOT NULL, sets_won INT NOT NULL, INDEX IDX_DA85878CE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
