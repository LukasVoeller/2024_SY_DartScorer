 ...
 */
final class Version20240621181740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, player1_id INT NOT NULL, player2_id INT NOT NULL, starting_player_id INT NOT NULL, winner_player_id INT DEFAULT NULL, state VARCHAR(32) DEFAULT NULL, type VARCHAR(32) DEFAULT NULL, match_mode VARCHAR(32) NOT NULL, match_mode_sets_needed INT DEFAULT NULL, match_mode_legs_needed INT DEFAULT NULL, to_throw_player_id INT DEFAULT NULL, date DATETIME NOT NULL, game_mode VARCHAR(255) NOT NULL, start_score INT DEFAULT NULL, finish_type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game_tally (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, player_id INT NOT NULL, score INT NOT NULL, leg_id INT NOT NULL, set_id INT DEFAULT NULL, legs_won INT DEFAULT NULL, sets_won INT DEFAULT NULL, INDEX IDX_DA85878CE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
